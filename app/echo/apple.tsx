            ...
            <Container style={container}>
                <Section>
                    <Row>
                        <Column>
                            <Img
                                src={`https://react-email-demo-ndjnn09xj-resend.vercel.app/static/apple-logo.png`}
                                width="42"
                                height="42"
                                alt="Apple Logo"
                            />
                ...
                <Section>
                    <Row>
                        <Column style={{ width: "64px" }}>
                            <Img
                                src={`https://react-email-demo-ndjnn09xj-resend.vercel.app/static/apple-hbo-max-icon.jpeg`}
                                width="64"
                                height="64"
                                alt="HBO Max"
                                style={productIcon}
...
export function renderReactAppleEmail(payload: any) {
    return render(<AppleReceiptEmail {...payload} />);
}